...
function App() {
  ...
  return (
    ...
    <div className='flex justify-center w-full h-svh duration-200' style={{ backgroundColor: color }}>
      
      <div className='fixed flex flex-wrap justify-center bottom-12 insert-x-0 px-3'>
